...
(
 ...
 email       varchar(100)    unique not null,            -- 중복 방지용 메일 인증
...
(
 ...
 cdt            datetime,                   -- 생성 일자
 oid            bigint,                     -- 원조자      => 나중에 복사하는 경우 최초 생성자 id값 계속 들고가게 해서 원조(?) 판별
...
(
 ...
 travel_sq      bigint not null,            -- 여행지 순서(클릭 좌표)            sq, 위도 경도 불필요하니깐 삭제? 241026
